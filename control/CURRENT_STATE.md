...
python -m pytest tests/test_etf_eu_cockpit_pdf_premium_surface.py tests/test_etf_eu_cockpit_pdf_premium_surface_review_checkpoint.py -q
36 passed before WP15I decision/reconcile line
```
