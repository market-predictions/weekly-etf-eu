...
requested_at_utc: 2026-06-02T04:30:00Z
mode: phase4_ishares_endpoint_structure_probe_validation

## Purpose

Queue the dedicated Yahoo fallback gate validation workflow after adding the bounded iShares endpoint structure probe.
...
- build and validate iShares endpoint structure probe for cwpScreenerApi and productScreenerV3Api only;
- build and validate Yahoo fallback gate shadow evidence including structure probe evidence;
