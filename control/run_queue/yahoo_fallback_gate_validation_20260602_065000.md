...
requested_at_utc: 2026-06-02T04:50:00Z
mode: phase4_ishares_controlled_parser_probe_validation

## Purpose

Queue the dedicated Yahoo fallback gate validation workflow after adding the diagnostic iShares controlled parser probe.
...
- build and validate iShares controlled parser probe for cwpScreenerApi and productScreenerV3Api only;
- build and validate Yahoo fallback gate shadow evidence including controlled parser probe evidence;
