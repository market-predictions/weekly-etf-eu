...
def main() -> None:
    ...
    validators = [
        "tools/validate_etf_eu_target_allocator_report_surface_v2.py",
        "tools/validate_etf_eu_incumbent_overlap_surface.py",
        "tools/validate_etf_eu_policy_report_reconciliation_v2.py",
    ...
    payload = {
        "schema_version": "etf_eu_allocator_report_validation_bundle_v5",
