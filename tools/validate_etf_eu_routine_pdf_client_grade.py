...
def validate_pdf(
    *,
    ...
    unique_isins = sorted(set(re.findall(r"\b[A-Z]{2}[A-Z0-9]{10}\b", pdf_text.upper())))
    pricing_rows_present = len(unique_isins) >= 8
    ...
    checks = [
        ...
        (pricing_rows_present, f"Expected at least 8 represented pricing lines, found {len(unique_isins)}"),
    ...
    return {
        "schema_version": "etf_eu_routine_pdf_client_grade_v1",
        ...
        "pricing_line_count_detected": len(unique_isins),
